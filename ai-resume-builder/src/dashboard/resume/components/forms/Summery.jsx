  ...
  const onSave = (e) => {
    ...
    GlobalApi.UpdateResumeDetail(params?.resumeId, data).then(
      (resp) => {
        ...
        console.error(error);
        toast.error("Failed to update resume details"); // Show error message
    })
    .finally(() => {
        setLoading(false); // Set loading to false once the request is done, regardless of success or failure
    });
  };
  return (
    <div>
